function u = control_predictivo_nn(yprev,uprev,xprev,model1, model2,r,n)
...
nonlcon = @(u) nonlcon_cart_nn(xprev, uprev, u, dumin, dumax, model2, n);
options = optimoptions('fmincon', 'Display', 'off');
uprox = fmincon(@(uprox)objective_nn(yprev, uprev, uprox, model1, r, n), uprox0, A, b, Aeq, beq, lb, ub, nonlcon, options);
